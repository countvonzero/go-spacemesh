...
func (app *App) initServices(
	...
	proposalListener := proposals.NewHandler(app.cachedDB, app.host, fetcherWrapped, beaconProtocol, msh, trtl, app.ballotExtract, vrfVerifier,
	...
	app.certifier = blocks.NewCertifier(app.cachedDB, hOracle, app.hareSign, app.hareExtract, app.host, clock, beaconProtocol, trtl,
	...
	atxBuilder := activation.NewBuilder(builderConfig, app.nodeID, app.atxSign, app.cachedDB, atxHandler, app.host, nipostBuilder,
